...
int main() {
 // Generate some realistic data for testing
    ...
    double smoothingFactor = 0.5;  // Adjust the smoothing factor as needed
    ...
    std::cout << "breaks: ";
    for (const auto &value : result.breaks) std::cout << value << " ";
    std::cout << "\ncoef1: ";
    for (const auto &value : result.coef1) std::cout << value << " ";
    std::cout << "\ncoef2: ";
    for (const auto &value : result.coef2) std::cout << value << " ";
    std::cout << "\ncoef3: ";
    for (const auto &value : result.coef3) std::cout << value << " ";
    std::cout << "\ncoef4: ";
    for (const auto &value : result.coef4) std::cout << value << " ";
    std::cout << "\ny: ";
    for (const auto &value : yValues) std::cout << value << " ";  
    std::cout << "\nyhs: ";
    for (const auto &value : y_interpolated) std::cout << value << " ";        
    std::cout << std::endl;
